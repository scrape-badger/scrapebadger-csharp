    ...
    public partial class VintedApi : IDisposable, IVintedApi
    {
        ...
        public ScrapeBadger.Client.ApiResponse<Object> VintedSearchByImageWithHttpInfo(VintedImageSearchRequest vintedImageSearchRequest)
        {
            ...
            if (vintedImageSearchRequest == null)
                throw new ScrapeBadger.Client.ApiException(400, "Missing required parameter 'vintedImageSearchRequest' when calling VintedApi->VintedSearchByImage");
            ...
            localVarRequestOptions.Data = vintedImageSearchRequest;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("VintedSearchByImage", localVarResponse);
                if (_exception != null) throw _exception;
            }
